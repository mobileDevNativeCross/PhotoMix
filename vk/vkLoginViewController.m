...
- (void)viewDidLoad
{
    ...
    NSString *authLink = [NSString stringWithFormat:@"http://api.vk.com/oauth/authorize?client_id=%@&scope=wall,photos,notes&redirect_uri=http://api.vk.com/blank.html&display=touch&response_type=token", appID];
...
-(void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    if ([vkWebView.request.URL.absoluteString rangeOfString:@"access_token"].location != NSNotFound) {
        ...
        [(VoilaViewController *)delegate authComplete];
