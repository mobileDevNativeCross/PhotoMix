...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request
 navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if ([host isEqualToString:@"www.mustachebashapp.com"]) {
        NSLog(@"At Yatterbox");
...
- (void)getAccessToken{
    [self.twitterOAuth synchronousRequestTwitterTokenWithCallbackUrl:@"http://www.mustachebashapp.com"];
//    [self.twitterOAuth synchronousRequestTwitterTokenWithCallbackUrl: @"oauthcallback://authorized"];
}
