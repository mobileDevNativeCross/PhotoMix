...
- (void) buyFeatureA: (int)tags :(NSString*)stache; // expose product buying functions, do not expose
- (void) buyFeatureB:(int)tags :(NSString*)stache; // your product ids. This will minimize changes when you change product ids later
- (void) buyFeatureC;
